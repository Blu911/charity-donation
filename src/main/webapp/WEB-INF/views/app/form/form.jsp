            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <h4>Adres odbioru</h4>
                        <div class="form-group form-group--inline">
                            <label> Numer mieszkania <input type="number" name="pickUpAddress" value="houseNumber"/>
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Numer domu <input type="number" name="pickUpAddress" value="flatNumber"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Ulica <input type="text" name="pickUpAddress" value="street"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Miasto <input type="text" name="pickUpAddress" value="city"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>
                                Kod pocztowy <input type="text" name="pickUpAddress" value="zipCode"/>
                            </label>
                        </div>
